...
int main(void)
{
    ...
    qp_problem_t *problem =
        create_qp_problem(NULL, &Q2, NULL, NULL, &A, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
    CHECK(problem == NULL);

    problem = create_qp_problem(NULL, NULL, &R2, NULL, &A, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
    CHECK(problem == NULL);

    matrix_desc_t R3 = empty_csr(1, 3, r_row_ptr);
    matrix_desc_t D2 = empty_csr(2, 2, q2_row_ptr);
    problem = create_qp_problem(NULL, NULL, &R3, &D2, &A, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
    CHECK(problem == NULL);
    ...
    problem =
        create_qp_problem(NULL, NULL, NULL, NULL, &invalid_A, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL);
    CHECK(problem == NULL);

    problem = create_qp_problem(NULL, NULL, NULL, NULL, &A, NULL, NULL, NULL, NULL, NULL, -1, NULL, 0, NULL, NULL);
    CHECK(problem == NULL);
    ...
    problem = create_qp_problem(NULL, NULL, NULL, NULL, &A, NULL, NULL, NULL, NULL, NULL, 1, &cone, 0, NULL, NULL);
    CHECK(problem != NULL);
